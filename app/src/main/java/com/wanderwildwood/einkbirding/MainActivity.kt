...
import com.wanderwildwood.einkbirding.databinding.ActivityMainBinding
  ...
  override fun onOptionsItemSelected(item: MenuItem): Boolean {
    when (item.itemId) {
      R.id.action_share_app -> {
        ...
        val shareBody = "https://github.com/wanderwildwood/eink-birding"
      ...
      R.id.action_info -> {
        startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/wanderwildwood/eink-birding")))
        return true
      }
